...
IntegrationServer -w %TEMP%\ace-mrm-compile-example-work-dir --mq-queue-manager-name dummy --start-msgflows false --no-nodejs --admin-rest-api -1 --test-project MRMMessageFlow_Test
